/****************************************************************************************************************************
  AsyncHTTPSRequest_ESP_WiFiManager.ino - Dead simple AsyncHTTPRequest for ESP8266, ESP32 and currently STM32 with built-in LAN8742A Ethernet
...
void setup()
{
	...
	Serial.print(F("\nStarting AsyncHTTPSRequest_ESP_WiFiManager using "));
